...
const AlertTitle = React.forwardRef(({ className, ...props }, ref) => (
  <h5
    ref={ref}
    className={cn('tw-text-justify tw-mb-1 tw-font-bold tw-leading-none tw-tracking-tight tw-text-lg', className)}
    {...props}
  />
));
...
const AlertDescription = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('tw-text-justify tw-text-base [&_p]:tw-leading-relaxed', className)}
    {...props}
  />
));
